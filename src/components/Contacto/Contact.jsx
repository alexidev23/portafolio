...
export function Contacto () {
  ...
  return (
    <section id='contacto' className='w-[800px] sm:m-auto'>
      <h2 className='text-4xl font-bold uppercase text-links pt-20 mb-8'>Contacto</h2>
      <div className='bg-contact flex mb-20 px-2 py-4 gap-4 w-[750px] sm:rounded-2xl'>
