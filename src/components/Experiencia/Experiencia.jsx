...
export function Experiencia () {
  return (
    <section id='experiencia' className='w-[800px] xs:w-full h-auto m-auto'>
      ...
      <div className='pb-10'>
        <div className='flex'>
          ...
          <div className='flex lg:gap-20 flex-col'>
            ...
            <div className='text-gray-300 w-[250px] mt-8 lg:w-[400px] pl-2'>
